...
\newpage
Il primo gruppo di plugin sono riguardano il contesto della sicurezza degli edifici, infatti
(Figura~\ref{fig:figura6}) essi sono: un estintore, un rilevatore di fumo, una cassetta naspo ed una
porta antipanico.
\begin{figure}[htbp]
\begin{center}
...
Il secondo gruppo di plugin riguardano il contesto tecnologico (Figura~\ref{fig:figura7}), essi sono
